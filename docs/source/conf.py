#
# Sphinx configuration for aiida-fujitsu-scheduler
#
...
import aiida_fujitsu_scheduler
...
project = "aiida-fujitsu-scheduler"
copyright_first_year = "2024"
copyright_owners = "Yuta Yahagi"
...
release = aiida_fujitsu_scheduler.__version__
...
html_title = f"aiida-fujitsu-scheduler v{release}"
html_theme_options = {}
...
html_use_opensearch = "https://aiida-fujitsu-scheduler.readthedocs.io"
...
def run_apidoc(_):
    ...
    package_dir = os.path.join(source_dir, os.pardir, os.pardir, "src", "aiida_fujitsu_scheduler")
